...
export default function CineControls({
  ...
  useEffect(() => {
    if (!open) setFpsPopoverOpen(false);
  }, [open]);
  ...
  return (
    <TooltipProvider>
      ...
      >
        <div className="pointer-events-auto inline-flex select-none items-center gap-2 rounded-lg border border-[#1e3a8a] bg-[#080b2e]/95 p-2 text-white shadow-2xl backdrop-blur-sm">
          <ToolbarTooltip
